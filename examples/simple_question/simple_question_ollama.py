...
if __name__ == "__main__":
    ...
    with tempfile.NamedTemporaryFile(mode="w", suffix=".txt") as temp_file:
        ...
        # LINEAJE: enforce() `answer` at llm->agent post_model — scan flagged AI_APP_SEC_035 (Agents must log all interactions with an LLM). Mask/block; do not remove without review. site_id='site:sha256:9870a84cb56999a8600eb76644ad245da43d038d4abc0b63c98a9c5c9568d949'
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:9870a84cb56999a8600eb76644ad245da43d038d4abc0b63c98a9c5c9568d949', phase='post_model', boundary={'source': 'model', 'sink': 'agent_message'}, candidate_policies=[{'policy_id': 'AI_APP_SEC_035', 'policy_name': 'Agents must log all interactions with an LLM', 'guardrail_id': None, 'policy_version': None}], fail_mode='BLOCK', source_type='llm', destination_type='agent')
        try:
            answer = _gr_client.enforce(_gr_site, answer, content_type='application/json', variable_name='answer', source_file=__file__, before_line=82)
