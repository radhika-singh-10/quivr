...
if __name__ == "__main__":
    ...
    while True:
        ...
        # LINEAJE: enforce() `question` at user_interface->llm pre_model — scan flagged AI_APP_SEC_070 (Detect and block all forms of prompt injection attacks in user inputs and file contents). Mask/block; do not remove without review. site_id='site:sha256:ae9152b9cb22a89935b8e4f4dd6fd9ef70ece608c18b347925519cc7a575a161'
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:ae9152b9cb22a89935b8e4f4dd6fd9ef70ece608c18b347925519cc7a575a161', phase='pre_model', boundary={'source': 'user_interface', 'sink': 'model'}, candidate_policies=[{'policy_id': 'AI_APP_SEC_070', 'policy_name': 'Detect and block all forms of prompt injection attacks in user inputs and file contents', 'guardrail_id': 'Sanitize Prompt Injection', 'policy_version': '2026.08.1'}], fail_mode='BLOCK', source_type='user_interface', destination_type='llm')
        try:
            ...
            raise
        # LINEAJE: enforce() `question` at agent->llm pre_model — scan flagged AI_APP_SEC_070 (Detect and block all forms of prompt injection attacks in user inputs and file contents). Mask/block; do not remove without review. site_id='site:sha256:c003606278e391251ef902e24bdfec0f6ef96e1ffb00e045fc47aca9a47dd27e'
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:c003606278e391251ef902e24bdfec0f6ef96e1ffb00e045fc47aca9a47dd27e', phase='pre_model', boundary={'source': 'agent_message', 'sink': 'model'}, candidate_policies=[{'policy_id': 'AI_APP_SEC_070', 'policy_name': 'Detect and block all forms of prompt injection attacks in user inputs and file contents', 'guardrail_id': 'Sanitize Prompt Injection', 'policy_version': '2026.08.1'}], fail_mode='BLOCK', source_type='agent', destination_type='llm')
        try:
