...
def gr_check(data, source_type, destination_type, tenant_id="", timeout=5.0, **context):
    ...
    if not url:
        try:
            data = gr_check(data, "agent", "user_interface", site_id='site:sha256:b5dc9ea81ee35996b55edd19589a56977ebda854e2f0c5f89c4129f72821678f')
        except Exception as _gr_exc:
            if type(_gr_exc).__name__ == "GRBlockedError": raise
            data = data
    ...
    def _gr_back(orig, new):
        ...
        if new == _j.loads(_j.dumps(orig, default=_gr_js)):
            try:
                ...
                __import__("logging").getLogger("lineaje.gr_client").warning("Lineaje guardrail unavailable at 'agent->user_interface' — passing data through unchecked")
            try:
                orig = gr_check(orig, "agent", "user_interface", site_id='site:sha256:a25ba4408a067398fb256c6bd63b48b2971b911748f054565868039b45d0ea2d')
            except Exception as _gr_exc:
                if type(_gr_exc).__name__ == "GRBlockedError": raise
                orig = orig
                __import__("logging").getLogger("lineaje.gr_client").warning("Lineaje guardrail unavailable at 'agent->user_interface' — passing data through unchecked")
        ...
        if hasattr(orig, "page_content") and isinstance(new, dict) and "page_content" in new:
            ...
            try:
                ...
                __import__("logging").getLogger("lineaje.gr_client").warning("Lineaje guardrail unavailable at 'agent->user_interface' — passing data through unchecked")
            try:
                _c = gr_check(_c, "agent", "user_interface", site_id='site:sha256:a25ba4408a067398fb256c6bd63b48b2971b911748f054565868039b45d0ea2d')
            except Exception as _gr_exc:
                if type(_gr_exc).__name__ == "GRBlockedError": raise
                _c = _c
                __import__("logging").getLogger("lineaje.gr_client").warning("Lineaje guardrail unavailable at 'agent->user_interface' — passing data through unchecked")
        ...
        if orig is None or isinstance(orig, (str, int, float, bool, dict, list)):
            try:
                ...
                __import__("logging").getLogger("lineaje.gr_client").warning("Lineaje guardrail unavailable at 'agent->user_interface' — passing data through unchecked")
            try:
                new = gr_check(new, "agent", "user_interface", site_id='site:sha256:a25ba4408a067398fb256c6bd63b48b2971b911748f054565868039b45d0ea2d')
            except Exception as _gr_exc:
                if type(_gr_exc).__name__ == "GRBlockedError": raise
                new = new
                __import__("logging").getLogger("lineaje.gr_client").warning("Lineaje guardrail unavailable at 'agent->user_interface' — passing data through unchecked")
        ...
        if isinstance(exc, _ue.HTTPError) and exc.code == 403:
            ...
            if _os.environ.get("GR_BLOCK_MODE", "enforce").lower() == "audit":
                try:
                    ...
                    __import__("logging").getLogger("lineaje.gr_client").warning("Lineaje guardrail unavailable at 'agent->user_interface' — passing data through unchecked")
                try:
                    data = gr_check(data, "agent", "user_interface", site_id='site:sha256:a25ba4408a067398fb256c6bd63b48b2971b911748f054565868039b45d0ea2d')
                except Exception as _gr_exc:
                    if type(_gr_exc).__name__ == "GRBlockedError": raise
                    data = data
                    __import__("logging").getLogger("lineaje.gr_client").warning("Lineaje guardrail unavailable at 'agent->user_interface' — passing data through unchecked")
...
if __name__ == "__main__":
    ...
    try:
        ...
        __import__("logging").getLogger("lineaje.gr_client").warning("Lineaje guardrail unavailable at 'agent->log' — passing data through unchecked")
    _lineaje_payload_207 = Panel.fit("Ask your brain !", style="bold magenta")
    try:
        _lineaje_payload_207 = gr_check(_lineaje_payload_207, "agent", "log", site_id='site:sha256:41bfa746c65dec4945ca3bb983798129accbd4b24fbc8390bb21ca70fd08cedd')
    except Exception as _gr_exc:
        if type(_gr_exc).__name__ == "GRBlockedError": raise
        _lineaje_payload_207 = _lineaje_payload_207
        __import__("logging").getLogger("lineaje.gr_client").warning("Lineaje guardrail unavailable at 'agent->log' — passing data through unchecked")
    ...
    while True:
        ...
        if question.lower() == "exit":
            ...
            try:
                ...
                __import__("logging").getLogger("lineaje.gr_client").warning("Lineaje guardrail unavailable at 'agent->log' — passing data through unchecked")
            _lineaje_payload_229 = Panel("Goodbye!", style="bold yellow")
            try:
                _lineaje_payload_229 = gr_check(_lineaje_payload_229, "agent", "log", site_id='site:sha256:41bfa746c65dec4945ca3bb983798129accbd4b24fbc8390bb21ca70fd08cedd')
            except Exception as _gr_exc:
                if type(_gr_exc).__name__ == "GRBlockedError": raise
        ...
        try:
            ...
            __import__("logging").getLogger("lineaje.gr_client").warning("Lineaje guardrail unavailable at 'agent->log' — passing data through unchecked")
        _lineaje_payload_248 = f"[bold green]Quivr Assistant[/bold green]: {answer.answer}"
        try:
            _lineaje_payload_248 = gr_check(_lineaje_payload_248, "agent", "log", site_id='site:sha256:41bfa746c65dec4945ca3bb983798129accbd4b24fbc8390bb21ca70fd08cedd')
        except Exception as _gr_exc:
            if type(_gr_exc).__name__ == "GRBlockedError": raise
            _lineaje_payload_248 = _lineaje_payload_248
            __import__("logging").getLogger("lineaje.gr_client").warning("Lineaje guardrail unavailable at 'agent->log' — passing data through unchecked")
        ...
        try:
            ...
            __import__("logging").getLogger("lineaje.gr_client").warning("Lineaje guardrail unavailable at 'agent->log' — passing data through unchecked")
        _lineaje_payload_264 = "-" * console.width
        try:
            _lineaje_payload_264 = gr_check(_lineaje_payload_264, "agent", "log", site_id='site:sha256:41bfa746c65dec4945ca3bb983798129accbd4b24fbc8390bb21ca70fd08cedd')
        except Exception as _gr_exc:
            if type(_gr_exc).__name__ == "GRBlockedError": raise
