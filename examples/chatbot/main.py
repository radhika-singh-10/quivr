...
async def on_chat_start():
    ...
    while files is None:
        ...
        files = await __import__('asyncio').to_thread(lambda: _gr_client.enforce(_gr_site, files, content_type='application/json', variable_name='files', source_file=__file__, before_line=39))
