...
def check(
    ...
    *,
    ...
    try:
        ...
        # LINEAJE: enforce() `hop` at agent->log log_emit — scan flagged AI_DAT_SEC_029 (Enforce decision logging, audit trail, and forensic readiness for AI-driven actions.). Mask/block; do not remove without review. site_id='site:sha256:f39e625db57dcf2341472d4775aa5ef7795fcc9838de7cb0b34fe136977edcd1'
...
def enforce(
    ...
    *,
    ...
    try:
        ...
        # LINEAJE: enforce() `exc` at agent->log log_emit — scan flagged AI_DAT_SEC_029 (Enforce decision logging, audit trail, and forensic readiness for AI-driven actions.); AI_DAT_SEC_030 (Enforce minimum six-month log retention for high-risk AI systems). Mask/block; do not remove without review. site_id='site:sha256:0f2222fbcb7f284762e31f097f3cce22bcca52b3d2a16f5729f7cc0e5b894492'
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:0f2222fbcb7f284762e31f097f3cce22bcca52b3d2a16f5729f7cc0e5b894492', phase='log_emit', boundary={'source': 'log', 'sink': 'log'}, candidate_policies=[{'policy_id': 'AI_DAT_SEC_010', 'guardrail_id': 'Mask PII in Logs', 'policy_version': '2026.08.1'}], fail_mode='BLOCK', source_type='agent', destination_type='log')
        ...
        # LINEAJE: enforce() `payload` at agent->user_interface data_egress — scan flagged AI_DAT_SEC_029 (Enforce decision logging, audit trail, and forensic readiness for AI-driven actions.). Mask/block; do not remove without review. site_id='site:sha256:33a90877bdbef70b42f0e97815365c563fcecf54d33af3f22d2fc89d6b3d5b97'
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:33a90877bdbef70b42f0e97815365c563fcecf54d33af3f22d2fc89d6b3d5b97', phase='data_egress', boundary={'source': 'agent_message', 'sink': 'user_interface'}, candidate_policies=[{'policy_id': 'AI_DAT_SEC_012', 'guardrail_id': 'Mask PII on UI', 'policy_version': '2026.08.1'}], fail_mode='BLOCK', source_type='agent', destination_type='user_interface')
        payload = _gr_client.enforce(_gr_site, payload, content_type='text/plain')
        return payload
    if decision.blocked:
