    ...
    with open("response.jsonl", "w") as f:
        async for event in conversational_qa_chain.astream_events(
            ...
            if (
                ...
                _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:5c68389e092835bfceae8e47f5bc611a1349443c14c403a6dc79dca9fb96a8d8', phase='data_egress', boundary={'source': 'agent_message', 'sink': 'external_endpoint'}, candidate_policies=[{'policy_id': 'AI_APP_SEC_029', 'guardrail_id': None, 'policy_version': None}], fail_mode='ALLOW_WITH_AUDIT', source_type='agent', destination_type='external')
