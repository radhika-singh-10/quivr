...
def test_llm_endpoint_from_config_default():
    ...
    # LINEAJE: enforce() `llm` at llm->agent post_model — scan flagged AI_IAC_024 (General purpose AI model integrations must reference a model card or technical documentation). Mask/block; do not remove without review. site_id='site:sha256:fcba8651eb85d7aef7a0290d95216f571f6adff2151ab0839ba57c30fa95f8ed'
    _gr_client = _lineaje_load_gr_client()
    _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:fcba8651eb85d7aef7a0290d95216f571f6adff2151ab0839ba57c30fa95f8ed', phase='post_model', boundary={'source': 'model', 'sink': 'agent_message'}, candidate_policies=[{'policy_id': 'AI_DAT_SEC_029', 'guardrail_id': 'Emit immutable, forensic-ready audit records for all AI decisions.', 'policy_version': '2026.08.1'}, {'policy_id': 'AI_IAC_024', 'guardrail_id': None, 'policy_version': None}], fail_mode='BLOCK', source_type='llm', destination_type='agent')
