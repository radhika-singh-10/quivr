...
async def test_quivrqaraglanggraph(
    ...
    # LINEAJE: enforce() `llm_config` at user_interface->tool pre_tool — scan flagged AI_IAC_024 (General purpose AI model integrations must reference a model card or technical documentation). Mask/block; do not remove without review. site_id='site:sha256:55273cb1b3f599cbe677f2da0a482ee15d48bd4b75841331ea1455ea20b2dcb3'
    _gr_client = _lineaje_load_gr_client()
    _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:55273cb1b3f599cbe677f2da0a482ee15d48bd4b75841331ea1455ea20b2dcb3', phase='pre_tool', boundary={'source': 'user_interface', 'sink': 'tool_result'}, candidate_policies=[{'policy_id': 'AI_IAC_024', 'guardrail_id': None, 'policy_version': None}], fail_mode='ALLOW_WITH_AUDIT', source_type='user_interface', destination_type='tool')
