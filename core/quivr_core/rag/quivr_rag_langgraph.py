...
class QuivrQARAGLangGraph:
    ...
    def generate_chat_llm(self, state: AgentState) -> AgentState:
        ...
        try:
            _lineaje_payload_1223 = gr_check(_lineaje_payload_1223, "agent", "llm", candidate_policies=['AI_APP_SEC_006', 'AI_APP_SEC_035'], site_id='site:sha256:b99c8b128ef45c6c98e32d135a527e0a72d8c36eea4bf1d964bf5a704dd69716')
        except Exception as _gr_exc:
            if type(_gr_exc).__name__ == "GRBlockedError": raise
