        ...
        for supplier, models in cls._model_defaults.items():
            ...
            for base_model_name in models:
                if model.startswith(base_model_name):
                    ...
                    _gr_client = _lineaje_load_gr_client()
                    _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:bc3cf756aa7af5f0133198522d3f3e050df3ffcff2dc9a1bcc7bc5860f64cd96', phase='data_egress', boundary={'source': 'agent_message', 'sink': 'user_interface'}, candidate_policies=[{'policy_id': 'AI_DAT_SEC_012', 'guardrail_id': 'Mask PII on UI', 'policy_version': '2026.08.1'}], fail_mode='BLOCK', source_type='agent', destination_type='user_interface')
    ...
    def get_llm_model_config(
        ...
        for key, config in supplier_defaults.items():
            if model_name.startswith(key):
                ...
                _gr_client = _lineaje_load_gr_client()
                _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:d42ac6bff53ae33c6fad008ff2035c9dbc0f304450cb6af19b16539f2dcc8daa', phase='data_egress', boundary={'source': 'agent_message', 'sink': 'user_interface'}, candidate_policies=[{'policy_id': 'AI_DAT_SEC_012', 'guardrail_id': 'Mask PII on UI', 'policy_version': '2026.08.1'}], fail_mode='BLOCK', source_type='agent', destination_type='user_interface')
