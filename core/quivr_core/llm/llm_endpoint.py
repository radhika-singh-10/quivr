...
class LLMTokenizer:
    ...
    def __init__(self, tokenizer_hub: str | None, fallback_tokenizer: str):
        ...
        if self.tokenizer_hub:
            ...
            try:
                ...
                # LINEAJE: enforce() `_lineaje_payload` at agent->log log_emit — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.); AI_APP_SEC_028 (Do not use LLMs from the organization's disallowed list); AI_APP_SEC_071 (Enforce chemical, biological, radiological, or nuclear (CBRN) threat prevention safeguards in AI-enabled systems). Mask/block; do not remove without review. site_id='site:sha256:5c6a6c5e82edb580ed4cab54a9cb7ba4af17657e237d98a84ab76e14ad6a4a90'
    ...
    def load(cls, tokenizer_hub: str, fallback_tokenizer: str):
        ...
        if cache_key in cls._cache:
            ...
            # LINEAJE: enforce() `tokenizer` at agent->user_interface data_egress — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.); AI_APP_SEC_028 (Do not use LLMs from the organization's disallowed list); AI_APP_SEC_071 (Enforce chemical, biological, radiological, or nuclear (CBRN) threat prevention safeguards in AI-enabled systems). Mask/block; do not remove without review. site_id='site:sha256:42aa2857bf600e5ddc797debb910096c6af6fec90269378227a80c372d8a984f'
            _gr_client = _lineaje_load_gr_client()
...
class LLMEndpoint:
    ...
    def from_config(cls, config: LLMEndpointConfig = LLMEndpointConfig()):
        ...
        try:
            ...
            _gr_client = _lineaje_load_gr_client()
            _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:4c0d036e91ceb510563023d246840efd804ab1bbceffcbc39890822c72ae4dc9', phase='data_egress', boundary={'source': 'agent_message', 'sink': 'user_interface'}, candidate_policies=[{'policy_id': 'AI_DAT_SEC_012', 'guardrail_id': 'Mask PII on UI', 'policy_version': '2026.08.1'}, {'policy_id': 'AI_APP_SEC_006', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_APP_SEC_028', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_APP_SEC_071', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_IAC_015', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_IAC_024', 'guardrail_id': None, 'policy_version': None}], fail_mode='BLOCK', source_type='agent', destination_type='user_interface')
            instance = _gr_client.enforce(_gr_site, instance, content_type='text/plain')
            return instance
